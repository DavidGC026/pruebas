...
require_once 'connectione.php'; // Nueva conexión para ebooks
...
$carrito_ebooks_id = $db3->getOrCreateUserCart($user_id); // Nuevo carrito ebooks

// Obtener productos de todos los carritos
$mercancia = $db->getCartItems($carrito_id);
$libros = $db2->getCartItems($user_id);
$ebooks = $db3->getCartItems($user_id); // Items de ebooks
...
<body>
    <div class="container mt-5">
        <div class="cart-section">
            ...
            <?php if (empty($mercancia) && empty($libros) && empty($ebooks)): ?>
